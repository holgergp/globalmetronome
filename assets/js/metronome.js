...
function play() {
  ...
  if (isPlaying) {
    ...
    timerWorker.start("start");
    //document.querySelector('.btn').style.display = 'none';
    show_icon("i4m-play-icon");
    show_icon("i4m-play-icon2");
    hide_icon("i4m-pause-icon");
    hide_icon("i4m-pause-icon2");
    //document.getElementById("play-icon").innerHTML = "pause";
  } else {
    timerWorker.stop("stop");
    show_icon("i4m-pause-icon");
    show_icon("i4m-pause-icon2");
    hide_icon("i4m-play-icon");
    hide_icon("i4m-play-icon2");
    //document.getElementById("i4m-play-icon").innerHTML = "play_arrow";
  }
}
...
function init(){
  ...
  timerWorker = new GlobalMetronome();     // The Web Worker used to fire timer messages
  timerWorker.init(document);
